...
def download_adm_image256_uncond_ckpt(ckpt_dir="data/"):
    ...
    print("Saved adm uncond pretrain models at {ckpt_pkl=} and {ckpt_pt}!")
...
def download_adm_image256_cond_ckpt(ckpt_dir="data/"):
    ...
    print("Saved adm cond pretrain models at {ckpt_pkl=} and {ckpt_pt}!")
...
def build_ckpt_option(opt, log, ckpt_path):
    ...
    log.info("Loaded options from {opt_pkl_path=}!")
